...
# For ..
data = pickle.load(open('../data/processed/ANN_outer_5_test_DS1234_{}.pkl'.format(groups[0]),'rb'))
ANN_DS1234_groups_data[groups[0]] = extract_ANN_data_for_plot_no_DS(data)
ANN_DS1234_groups_data
