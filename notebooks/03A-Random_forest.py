...
# Use above tables to rename the groups according to how many times (out of 5) they appear in top 10 SHAP features.
# Adjust manually according to the above results to rename the features
...
manual_groups_test_RF_CL[np.where(manual_groups_test_RF_CL == 'DS1_PEP_BOND_COUNT,DS1_length,DS1_mw')[0].item()] = 'DS1_PEP_BOND_COUNT,DS1_length,DS1_MW[5/5]'
manual_groups_test_RF_CL[np.where(manual_groups_test_RF_CL == "DS2_molwt,DS2_tpsa,DS4_0")[0].item()] = "DS2_molwt,DS2_tpsa,DS4_PC_0 [5/5]"
manual_groups_test_RF_CL[np.where(manual_groups_test_RF_CL == "DS1_hydrophobic_ratio")[0].item()] = "DS1_hydrophobic_ratio[5/5]"
manual_groups_test_RF_CL[np.where(manual_groups_test_RF_CL == "DS1_ss_bridge_count")[0].item()] = "DS1_SS_BRIDGE_COUNT[5/5]"
manual_groups_test_RF_CL[np.where(manual_groups_test_RF_CL == "DS2_mollogp")[0].item()] = "DS2_mollogp[5/5]"
manual_groups_test_RF_CL[np.where(manual_groups_test_RF_CL == "DS2_maxestateindex,DS2_minestateindex")[0].item()] = "DS2_maxestateindex,DS2_minestateindex[4/5]"
manual_groups_test_RF_CL[np.where(manual_groups_test_RF_CL == "DS1_non_polar_ratio")[0].item()] = "DS1_non_polar_ratio[3/5]"
manual_groups_test_RF_CL[np.where(manual_groups_test_RF_CL == "DS1_ALOGP_PP")[0].item()] = "DS1_ALOGP[3/5]"
manual_groups_test_RF_CL[np.where(manual_groups_test_RF_CL == "DS1_ch_acid,DS1_charge")[0].item()] = "DS1_ch_acid,DS1_charge [5/5]"
manual_groups_test_RF_CL[np.where(manual_groups_test_RF_CL == "DS4_2")[0].item()] = "DS4_PC_2[3/5]"
manual_groups_test_RF_CL[np.where(manual_groups_test_RF_CL == "DS4_3")[0].item()] = "DS4_PC_3[3/5]"
manual_groups_test_RF_CL[np.where(manual_groups_test_RF_CL == "DS4_7")[0].item()] = "DS4_PC_7[3/5]"
manual_groups_test_RF_CL[np.where(manual_groups_test_RF_CL == "DS4_8")[0].item()] = "DS4_PC_8[3/5]"
manual_groups_test_RF_CL[np.where(manual_groups_test_RF_CL == "DS4_1")[0].item()] = "DS4_PC_1[4/5]"


manual_groups_test_RF_T12 = np.array(pd_features_grouped_T12.columns)

manual_groups_test_RF_T12[np.where(manual_groups_test_RF_T12 == 'DS1_PEP_BOND_COUNT,DS1_length,DS1_mw')[0].item()] = 'DS1_PEP_BOND_COUNT,DS1_length,DS1_MW[5/5]'
manual_groups_test_RF_T12[np.where(manual_groups_test_RF_T12 == "DS2_molwt,DS2_tpsa,DS4_0")[0].item()] = "DS2_molwt,DS2_tpsa,DS4_PC_0 [5/5]"
manual_groups_test_RF_T12[np.where(manual_groups_test_RF_T12 == "DS1_hydrophobic_ratio")[0].item()] = "DS1_hydrophobic_ratio[5/5]"
manual_groups_test_RF_T12[np.where(manual_groups_test_RF_T12 == "DS1_ss_bridge_count")[0].item()] = "DS1_SS_BRIDGE_COUNT[5/5]"
manual_groups_test_RF_T12[np.where(manual_groups_test_RF_T12 == "DS2_mollogp")[0].item()] = "DS2_mollogp[5/5]"
manual_groups_test_RF_T12[np.where(manual_groups_test_RF_T12 == "DS2_maxestateindex,DS2_minestateindex")[0].item()] = "DS2_maxestateindex,DS2_minestateindex[4/5]"
manual_groups_test_RF_T12[np.where(manual_groups_test_RF_T12 == "DS1_non_polar_ratio")[0].item()] = "DS1_non_polar_ratio[3/5]"
manual_groups_test_RF_T12[np.where(manual_groups_test_RF_T12 == "DS1_ALOGP_PP")[0].item()] = "DS1_ALOGP[4/5]"
manual_groups_test_RF_T12[np.where(manual_groups_test_RF_T12 == "DS1_charge_density")[0].item()] = "DS1_charge_density[3/5]"
manual_groups_test_RF_T12[np.where(manual_groups_test_RF_T12 == "DS4_2")[0].item()] = "DS4_PC_2[3/5]"
manual_groups_test_RF_T12[np.where(manual_groups_test_RF_T12 == "DS1_ch_acid,DS1_charge")[0].item()] = "DS1_ch_acid,DS1_charge [4/5]"
manual_groups_test_RF_T12[np.where(manual_groups_test_RF_T12 == "DS4_7")[0].item()] = "DS4_PC_7[4/5]"
manual_groups_test_RF_T12[np.where(manual_groups_test_RF_T12 == "DS4_1")[0].item()] = "DS4_PC_1[3/5]"
manual_groups_test_RF_T12[np.where(manual_groups_test_RF_T12 == "DS4_3")[0].item()] = "DS4_PC_3[3/5]"

manual_groups_test_RF_MRT = np.array(pd_features_grouped_MRT.columns)

manual_groups_test_RF_MRT[np.where(manual_groups_test_RF_MRT == 'DS1_PEP_BOND_COUNT,DS1_length,DS1_mw')[0].item()] = 'DS1_PEP_BOND_COUNT,DS1_length,DS1_MW[5/5]'
manual_groups_test_RF_MRT[np.where(manual_groups_test_RF_MRT == "DS2_molwt,DS2_tpsa,DS4_0")[0].item()] = "DS2_molwt,DS2_tpsa,DS4_PC_0[5/5]"
manual_groups_test_RF_MRT[np.where(manual_groups_test_RF_MRT == "DS1_hydrophobic_ratio")[0].item()] = "DS1_hydrophobic_ratio[5/5]"
manual_groups_test_RF_MRT[np.where(manual_groups_test_RF_MRT == "DS1_ss_bridge_count")[0].item()] = "DS1_SS_BRIDGE_COUNT[5/5]"
manual_groups_test_RF_MRT[np.where(manual_groups_test_RF_MRT == "DS2_mollogp")[0].item()] = "DS2_mollogp[4/5]"
manual_groups_test_RF_MRT[np.where(manual_groups_test_RF_MRT == "DS2_maxestateindex,DS2_minestateindex")[0].item()] = "DS2_maxestateindex,DS2_minestateindex[3/5]"
manual_groups_test_RF_MRT[np.where(manual_groups_test_RF_MRT == "DS1_non_polar_ratio")[0].item()] = "DS1_non_polar_ratio[4/5]"
manual_groups_test_RF_MRT[np.where(manual_groups_test_RF_MRT == "DS1_ALOGP_PP")[0].item()] = "DS1_ALOGP[4/5]"
manual_groups_test_RF_MRT[np.where(manual_groups_test_RF_MRT == "DS1_ch_acid,DS1_charge")[0].item()] = "DS1_charge_density[5/5]"
manual_groups_test_RF_MRT[np.where(manual_groups_test_RF_MRT == "DS4_2")[0].item()] = "DS4_PC_2[4/5]"
manual_groups_test_RF_MRT[np.where(manual_groups_test_RF_MRT == "DS4_7")[0].item()] = "DS4_PC_7[4/5]"
manual_groups_test_RF_MRT[np.where(manual_groups_test_RF_MRT == "DS4_1")[0].item()] = "DS4_PC_1[3/5]"
manual_groups_test_RF_MRT[np.where(manual_groups_test_RF_MRT == "DS4_3")[0].item()] = "DS4_PC_3[3/5]"
